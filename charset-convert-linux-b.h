...
int Gb2312ToUtf8(const char* inputData, string& outputData) {
    ...
    // cout << "before _Gb2312ToUtf8(inputData, inputLength, outputStr, outputLength);	" << endl;
	...
	// cout << "after _Gb2312ToUtf8(inputData, inputLength, outputStr, outputLength);	" << endl;
    
	// if (NULL != outputStr) {
	// 	delete[] outputStr; 
	// }	
    
    // cout <<"After delete[] outputStr;" << endl;
