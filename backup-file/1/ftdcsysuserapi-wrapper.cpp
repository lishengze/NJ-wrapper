...
NAN_METHOD(FtdcSysUserApi_Wrapper::RegisterFront) {
    cout <<"RegisterFront Called!" << endl;
    Local<String> fileData= info[0]->IsUndefined() ? Nan::EmptyString()  : info[0]->ToString();
    String::Utf8Value utf8Str(fileData);
...
NAN_METHOD(FtdcSysUserApi_Wrapper::RegisterSpi) {
    ...
    if(info[0]->IsObject())
    {
        ...
        obj->_spi->m_SpiObj.Reset(Nan::To<v8::Object>(info[0]).ToLocalChecked());
        obj->_spi->m_testValue = g_registerSpiNumb++;
        obj->_userApi->RegisterSpi(obj->_spi);
    }
    info.GetReturnValue().SetUndefined();
}
...
NAN_METHOD(FtdcSysUserApi_Wrapper::ReqQrySysUserLoginTopic) {
     std::cout<<"\n----------------------- ReqQrySysUserLoginTopic Called! ----------------------- "<<std::endl;
     FtdcSysUserApi_Wrapper* obj = ObjectWrap::Unwrap<FtdcSysUserApi_Wrapper>(info.Holder());
     if(!(info[0]->IsObject() && info[1]->IsNumber()))
     {
     Nan::ThrowError("wrong parameter!");
     ...
     // strcpy_s(field.UserID, 16, *paramOneUserIDStr);
     strncpy(field.UserID, *paramOneUserIDStr, 16);
     cout<< "\nWrapper::UserID:       " << *paramOneUserIDStr << "\n" << endl;
     //Password
     v8::Local<v8::Object> paramOnePasswordObj=Nan::To<v8::Object>( Nan::Get(paramOne,Nan::New<v8::String>("Password").ToLocalChecked()).ToLocalChecked() ).ToLocalChecked();
     v8::String::Utf8Value paramOnePasswordStr(Nan::To<v8::String>(paramOnePasswordObj).ToLocalChecked());
     //encrypt password
     ...
     std::cout<<"----------------------- ReqQrySysUserLoginTopic Called! -----------------------\n "<<std::endl;
 }
...
NAN_METHOD(FtdcSysUserApi_Wrapper::ReqQrySysUserRegisterTopic){
  ...
  // cout <<"(!(info[0]->IsObject() && info[1]->IsNumber() \n" << endl;
  //convert parameter one
  v8::Local<v8::Object> paramOne=Nan::To<v8::Object>(info[0]).ToLocalChecked();
  CShfeFtdcReqQrySysUserRegisterField field;

  // cout <<"v8::Local<v8::Object> paramOne=Nan::To<v8::Object>(info[0]).ToLocalChecked(); \n" << endl;
 //UserID
  v8::Local<v8::Object> paramOneUserIDObj=Nan::To<v8::Object>( Nan::Get(paramOne,Nan::New<v8::String>("UserID").ToLocalChecked()).ToLocalChecked() ).ToLocalChecked();
  v8::String::Utf8Value paramOneUserIDfileData(Nan::To<v8::String>(paramOneUserIDObj).ToLocalChecked());
  strncpy(field.UserID, *paramOneUserIDfileData, 16);

 //  cout <<"strncpy(field.UserID, *paramOneUserIDfileData, 16); \n" << endl;
 //UserName
 ...
 // cout <<"strncpy(field.UserName, *paramOneUserNamefileData, 16); \n" << endl;
 //UserInfo
 ...
 // cout <<"strncpy(field.UserInfo, *paramOneUserInfofileData, 100); \n" << endl;
 ...
 // cout <<"strncpy(field.Password, *paramOnePasswordfileData, 41); \n" << endl;
 //Privilege
 ...
 // cout <<" field.Privilege=paramOnePrivilegefileData->Value(); \n" << endl;
 //EMail
 ...
 //  cout <<"strncpy(field.EMail, *paramOneEMailfileData, 51); \n" << endl;
 //EMailFlag
 ...
 // cout <<"field.EMailFlag=paramOneEMailFlagfileData->Value(); \n" << endl;
 //HomePhone
 ...
 // cout <<"strncpy(field.HomePhone, *paramOneHomePhonefileData, 31); \n" << endl;
 //HomePhoneFlag
 ...
 // cout <<"field.HomePhoneFlag=paramOneHomePhoneFlagfileData->Value(); \n" << endl;
 //MobilePhone
 ...
 // cout <<"strncpy(field.MobilePhone, *paramOneMobilePhonefileData, 31); \n" << endl;
 //MobilePhoneFlag
  ...
  // cout <<" field.MobilePhoneFlag=paramOneMobilePhoneFlagfileData->Value(); \n" << endl;
  //convert parameter two
  v8::Local<v8::Integer> paramTwo=Nan::To<v8::Integer>(info[1]).ToLocalChecked();
  int64_t nRequestID=paramTwo->Value();

  // cout <<" v8::Local<v8::Integer> paramTwo=Nan::To<v8::Integer>(info[1]).ToLocalChecked(); \n" << endl;
  //call native method
