...
///@history 
///20020214	王肇东		创建该文件
///20070912 赵鸿昊		修改UNIX宏
///20070927 赵鸿昊		修正LINUX下singal头文件
///20080603 赵鸿昊		增加WIN32下的getopt函数
///20080727 赵鸿昊		增加stack头文件
///20090119 赵鸿昊		修改GET_ACCURATE_TIME，使得UNIX和WINN下含义相同：
///						当日毫秒数（NT-0065）
///20100423 江鹏        NT-0100：增加QWORD数据类型以支持64位整数
///20100430 江鹏        NT-0102：增强对超过4G大文件的支持
///20100903 江鹏        NT-0109：过滤掉非法浮点值
///20110509 江鹏        NT-0131：UserAPI功能完善，增加GetSysClock函数，修改了非windows的SLEEP实现
///20110519 江鹏        NT-0132：基础库完善，增加对64位整数支持
// 20110622 江鹏		NT-0138：增加系统度量功能，增加GetSysMicroClock函数
// 20110622 江鹏		NT-0138 增加系统度量功能：增加INT64类型
///20110901 赵鸿昊		NT-0150 增加GetPreciseTime函数，获取精确到微秒的当前时刻
///20120319 江鹏		增加对于xtp协议的精确度量功能
...
///对超过4G大文件的支持，要放在stdio.h标准头文件前才能生效
...
///在Vos下，我们需要使用pack(1)?庋膒ragma表示需要压紧结构。其他平台下的相应
///功能都在编译选项中实现
#ifdef VOS
//#pragma pack(1)
#endif
...
// 得到当前系统时钟，精确到毫秒（目前高位会溢出、只能用作相对值）
