...
///配置请求信息
struct CShfeFtdcReqQryMonConfigInfoField
{
	///配置名称
	TShfeFtdcConfigNameType	ConfigName;
	///配置参数
	TShfeFtdcString32Type	ConfigArg;
};

///配置应答信息
struct CShfeFtdcRspQryMonConfigInfoField
{
	///配置名称
	TShfeFtdcConfigNameType	ConfigName;
	///配置参数
	TShfeFtdcString32Type	ConfigArg;
	///配置内容
	TShfeFtdcConfigContentType	ConfigContent;
};

///配置推送信息
struct CShfeFtdcRtnMonConfigInfoField
{
	///配置名称
	TShfeFtdcConfigNameType	ConfigName;
	///配置参数
...
///监控日信息
struct CShfeFtdcMonitorDayInfoField
{
	///日期
	TShfeFtdcDateType	Date;
};

///交易日信息
struct CShfeFtdcTradingDayInfoField
{
	///日期
	TShfeFtdcDateType	Date;
};
...
///监控节信息
struct CShfeFtdcMonitorSectionField
{
	///监控节
	TShfeFtdcMonitorSectionType	MonitorSection;
};

///服务连接请求
struct CShfeFtdcReqMonServiceConnectField
{
	///服务名称
	TShfeFtdcServiceNameType	ServiceName;
	///服务ID
	TShfeFtdcServiceIDType	ServiceID;
};

///服务连接响应
struct CShfeFtdcRspMonServiceConnectField
{
	///服务名称
	TShfeFtdcServiceNameType	ServiceName;
	///服务ID
...
///Proxy或探针名称配置
struct CShfeFtdcRtnMonProxyConfigField
{
	///对端服务类型
	TShfeFtdcString64Type	RemoteName;
	///对端服务名称
	TShfeFtdcString64Type	RemoteID;
	///主机名称
	TShfeFtdcString64Type	HostName;
};

///服务的当前连接状态查询
struct CShfeFtdcReqQryMonServiceStatusField
{
	///服务类型
	TShfeFtdcString64Type	ServiceName;
	///服务名称
	TShfeFtdcString64Type	ServiceID;
	///服务状态
	TShfeFtdcSessionStatusType	Status;
};

///服务的当前连接状态响应
struct CShfeFtdcRspQryMonServiceStatusField
{
	///服务类型
	TShfeFtdcString64Type	ServiceName;
	///服务名称
...
///服务的当前连接状态
struct CShfeFtdcRtnMonServiceStatusField
{
	///服务类型
	TShfeFtdcString64Type	ServiceName;
	///服务名称
...
///当前数据中心角色
struct CShfeFtdcRtnMonDataCenterRoleField
{
	///数据中心名称
	TShfeFtdcString32Type	DataCenter;
	///数据中心角色
	TShfeFtdcDataCenterRoleType	Role;
};

///探针任务配置查询请求
struct CShfeFtdcReqQryMonProbeTaskField
{
	///探针名称
	TShfeFtdcString32Type	ProbeID;
	///任务类型
	TShfeFtdcString16Type	TaskType;
};

///探针任务配置查询响应
struct CShfeFtdcRspQryMonProbeTaskField
{
	///探针名称
	TShfeFtdcString32Type	ProbeID;
	///任务类型
	TShfeFtdcString16Type	TaskType;
	///任务描述
	TShfeFtdcString256Type	TaskDesc;
};

///探针任务配置推送
struct CShfeFtdcRtnMonProbeTaskField
{
	///探针名称
	TShfeFtdcString32Type	ProbeID;
	///任务类型
...
///文件读取偏移量查询请求
struct CShfeFtdcReqQryMonFileOffsetField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///文件名称
	TShfeFtdcFileNameType	FileName;
	///当前读取偏移量
	TShfeFtdcUINT64Type	ReadOffset;
	///当前读取时间
	TShfeFtdcMonTimeType	ReadTime;
};

///文件读取偏移量查询应答
struct CShfeFtdcRspQryMonFileOffsetField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///文件名称
...
///文件读取偏移量查询推送
struct CShfeFtdcRtnMonFileOffsetField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///文件名称
...
///文件内容查询请求
struct CShfeFtdcReqQryMonFileContentField
{
	///请求的文件名称
	TShfeFtdcFileNameType	FileName;
	///请求的文件类型
	TShfeFtdcString16Type	FileType;
	///请求的文件内容起点偏移量
	TShfeFtdcUINT64Type	ContentOffset;
	///请求的文件内容长度
	TShfeFtdcINT32Type	ContentLength;
};

///文件内容查询应答
struct CShfeFtdcRspQryMonFileContentField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	TShfeFtdcMonTimeType	MonTime;
	///文件名称
	TShfeFtdcFileNameType	FileName;
	///文件类型
	TShfeFtdcString16Type	FileType;
	...
	TShfeFtdcINT32Type	ContentLength;
	///装载的文件内容
	TShfeFtdcFileContentType	FileContent;
};

///文件内容推送
struct CShfeFtdcRtnMonFileContentField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///监控系统指标查询请求
struct CShfeFtdcReqQryMonObjectAttrField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///属性名
	TShfeFtdcDigitAttrTypeType	AttrType;
	///开始日期
	TShfeFtdcDateType	StartDate;
	///开始时间
	TShfeFtdcTimeType	StartTime;
...
///监控系统指标查询应答
struct CShfeFtdcRspQryMonObjectAttrField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///属性名
	...
	TShfeFtdcMonTimeType	MonTime;
	///指标值类型
	TShfeFtdcMonValueTypeType	ValueType;
	///指标值
	TShfeFtdcMonAttrValueType	AttrValue;
};

///监控系统指标查询推送
struct CShfeFtdcRtnMonObjectAttrField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///属性名
...
///监控系统Syslog事件查询请求
struct CShfeFtdcReqQryMonSyslogEventField
{
	///开始时间
	TShfeFtdcMonTimeType	StartTime;
	///结束时间
	TShfeFtdcMonTimeType	EndTime;
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///事件名称
	TShfeFtdcString64Type	EventName;
	///事件等级
	TShfeFtdcMonEventLevelType	EventLevel;
};

///监控系统Syslog事件查询应答
struct CShfeFtdcRspQryMonSyslogEventField
{
	///事件发生时间
	TShfeFtdcMonTimeType	OccurTime;
	///事件采集时间
	TShfeFtdcMonTimeType	MonTime;
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///事件ID
	TShfeFtdcUINT64Type	EventID;
	///事件名称
	TShfeFtdcString64Type	EventName;
	///事件描述
	TShfeFtdcString512Type	EventDesc;
	///事件描述标记
	TShfeFtdcMonEventDescFlagType	EventDescFlag;
	///事件等级
	TShfeFtdcMonEventLevelType	EventLevel;
};

///监控系统Syslog事件查询推送
struct CShfeFtdcRtnMonSyslogEventField
{
	///事件发生时间
	TShfeFtdcMonTimeType	OccurTime;
	///事件采集时间
...
///主机基础环境信息请求
struct CShfeFtdcReqQryMonHostBasicEnvField
{
	///主机的数字化对象ID
	TShfeFtdcDigitObjectIDType	HostID;
};

///主机基础环境信息响应
struct CShfeFtdcRspQryMonHostBasicEnvField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	TShfeFtdcMonTimeType	MonTime;
	///主机型号(操作系统类型)
	TShfeFtdcString32Type	HostModel;
	///主机内存大小
	TShfeFtdcINT32Type	MainMemory;
	///主机CPU厂商
	TShfeFtdcString32Type	CPUVendor;
	///主机CPU型号
	TShfeFtdcString32Type	CPUModel;
	///主机CPU主频
	TShfeFtdcString32Type	CPUMHz;
	///主机CPU缓存大小
	TShfeFtdcString32Type	CPUCache;
	///主机CPU核心数量
	TShfeFtdcINT32Type	CPUCores;
	///主机CPU个数
	TShfeFtdcINT32Type	Processors;
	///操作系统位数32/64
	TShfeFtdcINT32Type	OsMode;
};

///主机基础环境信息响应
struct CShfeFtdcRtnMonHostBasicEnvField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///主机基础网络信息查询
struct CShfeFtdcReqQryMonHostNetworkEnvField
{
	///主机的数字化对象ID
	TShfeFtdcDigitObjectIDType	HostID;
};
...
///主机基础网络信息响应
struct CShfeFtdcRspQryMonHostNetworkEnvField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	TShfeFtdcMonTimeType	MonTime;
	///网络硬件ID(网卡名称)
	TShfeFtdcString64Type	LanHardwareID;
	///网卡Mac地址
	TShfeFtdcString32Type	MACAddress;
	///网卡IP地址
	TShfeFtdcString16Type	IPAddress;
	///网卡掩码地址
	TShfeFtdcString16Type	IPMask;
};

///主机基础网络信息响应
struct CShfeFtdcRtnMonHostNetworkEnvField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///主机文件系统信息查询
struct CShfeFtdcReqQryMonHostFileSysEnvField
{
	///主机的数字化对象ID
	TShfeFtdcDigitObjectIDType	HostID;
};
...
///主机文件系统信息响应
struct CShfeFtdcRspQryMonHostFileSysEnvField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	TShfeFtdcMonTimeType	MonTime;
	///LVM Device File
	TShfeFtdcString32Type	LVMDeviceFile;
	///Mount Point
	TShfeFtdcString32Type	MountPoint;
	///File System Size
	TShfeFtdcUINT64Type	FSsize;
	///File System Type
	TShfeFtdcString32Type	FSType;
};

///主机文件系统信息通告
struct CShfeFtdcRtnMonHostFileSysEnvField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///主机交换分区信息查询
struct CShfeFtdcReqQryMonHostSwapEnvField
{
	///主机的数字化对象ID
	TShfeFtdcDigitObjectIDType	HostID;
};
...
///主机交换分区信息应答
struct CShfeFtdcRspQryMonHostSwapEnvField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	TShfeFtdcMonTimeType	MonTime;
	///交换分区类型
	TShfeFtdcString32Type	Type;
	///交换分区大小
	TShfeFtdcINT32Type	Size;
	///交换分区优先级
	TShfeFtdcINT32Type	Priority;
	///交换分区地址
	TShfeFtdcString32Type	Location;
};

///主机交换分区信息通告
struct CShfeFtdcRtnMonHostSwapEnvField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///主机的CPU信息指标信息请求
struct CShfeFtdcReqQryMonHostCPUAttrField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///主机的CPU编号
	TShfeFtdcString8Type	CpuID;
	///开始日期
	TShfeFtdcDateType	StartDate;
	///开始时间
	TShfeFtdcTimeType	StartTime;
...
///主机的CPU信息指标信息响应
struct CShfeFtdcRspQryMonHostCPUAttrField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	...
	TShfeFtdcString8Type	CpuID;
	///CPU LOAD值
	TShfeFtdcDoubleTypeType	LOAD;
	///CPU USER值
	TShfeFtdcDoubleTypeType	USER;
	///CPU NICE值
	TShfeFtdcDoubleTypeType	NICE;
	///CPU SYS值
	TShfeFtdcDoubleTypeType	SYS;
	///CPU IDLE值
	TShfeFtdcDoubleTypeType	IDLE;
	///CPU BLOCK值
	TShfeFtdcDoubleTypeType	BLOCK;
	///CPU SWAIT值
	TShfeFtdcDoubleTypeType	SWAIT;
	///CPU INTR值
	TShfeFtdcDoubleTypeType	INTR;
	///CPU SSYS值
	TShfeFtdcDoubleTypeType	SSYS;
};

///主机的CPU信息指标信息
struct CShfeFtdcRtnMonHostCPUAttrField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///主机的Memory信息指标信息请求
struct CShfeFtdcReqQryMonHostMemAttrField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///开始日期
...
///主机的Memory信息指标信息响应
struct CShfeFtdcRspQryMonHostMemAttrField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	TShfeFtdcMonTimeType	MonTime;
	///总的物理内存
	TShfeFtdcINT32Type	TOTALREAL;
	///可用物理内存
	TShfeFtdcINT32Type	ACTIVEREAL;
	///总的虚拟内存
	TShfeFtdcINT32Type	TOTALVIRTUAL;
	///可用虚拟内存
	TShfeFtdcINT32Type	ACTIVEVIRTUAL;
	///总的可用内存
	TShfeFtdcINT32Type	FREE;
};

///主机的Memory信息指标信息
struct CShfeFtdcRtnMonHostMemAttrField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///主机的FileSystem信息指标信息请求
struct CShfeFtdcReqQryMonHostFileSystemAttrField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///开始日期
...
///主机的FileSystem信息指标信息响应
struct CShfeFtdcRspQryMonHostFileSystemAttrField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	TShfeFtdcMonTimeType	MonTime;
	///文件系统物理名
	TShfeFtdcString64Type	FILESYSTEM;
	///加载位置
	TShfeFtdcString16Type	MountedOn;
	///文件系统类型
	TShfeFtdcString16Type	FSTYPE;
	///总大小
	TShfeFtdcUINT64Type	SIZE;
	///非超级用户可获取的大小
	TShfeFtdcUINT64Type	AVAIL;
	///已经使用的空间大小
	TShfeFtdcUINT64Type	USED;
	///使用率
	TShfeFtdcDoubleTypeType	pUSERD;
	///文件节点总数
	TShfeFtdcUINT64Type	ISIZE;
	///可用文件节点总数
	TShfeFtdcUINT64Type	IFREE;
	///已用文件节点总数
	TShfeFtdcUINT64Type	IUSED;
	///文件节点总数使用百分比
	TShfeFtdcDoubleTypeType	pIUSED;
};

///主机的FileSystem信息指标信息
struct CShfeFtdcRtnMonHostFileSystemAttrField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///主机的用户信息请求
struct CShfeFtdcReqQryMonHostUserInfoField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///开始日期
...
///主机的用户信息响应
struct CShfeFtdcRspQryMonHostUserInfoField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	TShfeFtdcMonTimeType	MonTime;
	///用户名
	TShfeFtdcString32Type	USERNAME;
	///密码
	TShfeFtdcString32Type	PASSWORD;
	///用户ID
	TShfeFtdcINT32Type	UID;
	///用户组ID
	TShfeFtdcINT32Type	GID;
	///HOME路径
	TShfeFtdcString32Type	HOMEDIR;
	///用户使用SHELL环境
	TShfeFtdcString32Type	USERSHELL;
	///用户组名
	TShfeFtdcString32Type	GROUPNAME;
};

///主机的用户信息
struct CShfeFtdcRtnMonHostUserInfoField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///主机的在线用户信息请求
struct CShfeFtdcReqQryMonHostOnlineUserInfoField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///开始日期
...
///主机的在线用户信息响应
struct CShfeFtdcRspQryMonHostOnlineUserInfoField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	...
	TShfeFtdcString32Type	USERNAME;
	///登录时间
	TShfeFtdcString32Type	TIME;
	///终端类型
	TShfeFtdcString32Type	TTY;
	///IP地址
	TShfeFtdcString32Type	IP;
	///进程ID
	TShfeFtdcINT32Type	PID;
	///连接时间
	TShfeFtdcString32Type	CONNECTIME;
};

///主机的在线用户信息
struct CShfeFtdcRtnMonHostOnlineUserInfoField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///主机的Network信息指标信息请求
struct CShfeFtdcReqQryMonHostNetworkAttrField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///开始日期
...
///主机的Network信息指标信息响应
struct CShfeFtdcRspQryMonHostNetworkAttrField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	TShfeFtdcMonTimeType	MonTime;
	///网卡名
	TShfeFtdcString16Type	NAME;
	///网卡的up或down状态
	TShfeFtdcString16Type	STATUS;
	///网卡的ip地址
	TShfeFtdcIPAddressType	IPADDRESS;
	///网卡掩码地址
	TShfeFtdcString32Type	MASK;
	///网卡MAC地址
	TShfeFtdcString32Type	MAC;
	///网卡接收的流量
	TShfeFtdcUINT64Type	RCVBYTES;
	///网卡接收的数据包
	TShfeFtdcUINT64Type	RCVPKGS;
	///网卡接收到的错误包数量
	TShfeFtdcUINT64Type	RCVERRPKGS;
	///网卡丢弃的包数量
	TShfeFtdcUINT64Type	RCVDRPPKGS;
	///网卡发送的字节数
	TShfeFtdcUINT64Type	SNDBYTES;
	///网卡发送的包数量
	TShfeFtdcUINT64Type	SNDPKGS;
	///网卡发送的包数量
	TShfeFtdcUINT64Type	SNDERRPKGS;
	///网卡发送的被丢弃包数量
	TShfeFtdcUINT64Type	SNDDRPPKGS;
};

///主机的Network信息指标信息
struct CShfeFtdcRtnMonHostNetworkAttrField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///主机的系统状态信息请求
struct CShfeFtdcReqQryMonHostStatInfoField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///开始日期
...
///主机的系统状态信息响应
struct CShfeFtdcRspQryMonHostStatInfoField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	TShfeFtdcMonTimeType	MonTime;
	///活跃进程数
	TShfeFtdcINT32Type	ProcRun;
	///阻塞进程数
	TShfeFtdcINT32Type	ProcBlk;
	///每秒由磁盘进入Swap的页面数
	TShfeFtdcINT32Type	SwapIn;
	///每秒由Swap进入磁盘的页面数
	TShfeFtdcINT32Type	SwapOut;
	///每秒从块设备读入的Block数
	TShfeFtdcINT32Type	BlockIn;
	///每秒向块设备写入的Block数
	TShfeFtdcINT32Type	BlockOut;
	///每秒设备中段次数
	TShfeFtdcINT32Type	Inter;
	///每秒上下文切换次数
	TShfeFtdcINT32Type	Context;
	///用户态CPU百分率
	TShfeFtdcDoubleTypeType	CPUUser;
	///系统态CPU百分率
	TShfeFtdcDoubleTypeType	CPUSys;
	///空闲态CPU百分率
	TShfeFtdcDoubleTypeType	CPUIdle;
	///IO等待态CPU百分率
	TShfeFtdcDoubleTypeType	CPUIOWait;
	///窃取态CPU百分率
	TShfeFtdcDoubleTypeType	CPUSteal;
};

///主机的系统状态信息
struct CShfeFtdcRtnMonHostStatInfoField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///主机的DiskIO信息指标信息请求
struct CShfeFtdcReqQryMonHostDiskIOAttrField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///开始日期
...
///主机的DiskIO信息指标信息响应
struct CShfeFtdcRspQryMonHostDiskIOAttrField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	TShfeFtdcMonTimeType	MonTime;
	///分区名
	TShfeFtdcString32Type	PartName;
	///每秒ReadMerge数
	TShfeFtdcDoubleTypeType	ReadMerges;
	///每秒WriteMerge数
	TShfeFtdcDoubleTypeType	WriteMerges;
	///每秒ReadIO数
	TShfeFtdcDoubleTypeType	ReadIOs;
	///每秒WriteIO数
	TShfeFtdcDoubleTypeType	WriteIOs;
	///每秒Read字节数
	TShfeFtdcDoubleTypeType	ReadKBs;
	///每秒Write字节数
	TShfeFtdcDoubleTypeType	WriteKBs;
	///Size值
	TShfeFtdcDoubleTypeType	SizeVal;
	///Queue值
	TShfeFtdcDoubleTypeType	QueueVal;
	///Svc_t值
	TShfeFtdcDoubleTypeType	Svc_t;
	///繁忙百分率
	TShfeFtdcDoubleTypeType	Busy;
};

///主机的DiskIO信息指标信息
struct CShfeFtdcRtnMonHostDiskIOAttrField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///主机的路由信息请求
struct CShfeFtdcReqQryMonHostRouterInfoField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///开始日期
...
///主机的路由信息响应
struct CShfeFtdcRspQryMonHostRouterInfoField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	TShfeFtdcMonTimeType	MonTime;
	///设备接口名
	TShfeFtdcString32Type	Dev;
	///目标网段ip地址
	TShfeFtdcString16Type	Destination;
	///网关ip地址
	TShfeFtdcString16Type	Gateway;
	///掩码ip地址
	TShfeFtdcString16Type	Mask;
	///网络状态
	TShfeFtdcString8Type	Flag;
	///关联计数
	TShfeFtdcINT32Type	RefCnt;
	///使用计数
	TShfeFtdcINT32Type	Use;
	///metric值
	TShfeFtdcINT32Type	Metric;
	///mtu值
	TShfeFtdcINT32Type	Mtu;
	///win值
	TShfeFtdcINT32Type	Win;
	///rtt值
	TShfeFtdcINT32Type	Rtt;
};

///主机的路由信息
struct CShfeFtdcRtnMonHostRouterInfoField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///主机的进程信息请求
struct CShfeFtdcReqQryMonHostProcessInfoField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///开始日期
...
///主机的进程信息响应
struct CShfeFtdcRspQryMonHostProcessInfoField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	...
	TShfeFtdcINT32Type	PID;
	///处理器号
	TShfeFtdcINT32Type	CPU;
	///终端名
	TShfeFtdcINT32Type	TTY;
	///用户名
	TShfeFtdcString32Type	USERNAME;
	///任务的优先级
	TShfeFtdcINT32Type	PRI;
	///任务的nice值
	TShfeFtdcINT32Type	NI;
	///任务的代码加上数据再加上栈空间的大小
	TShfeFtdcUINT64Type	SSIZE;
	///任务使用的物理内存的总数量
	TShfeFtdcUINT64Type	RES;
	///任务的状态
	TShfeFtdcProcessStateType	STATE;
	///自任务开始时使用的总CPU时间
	TShfeFtdcString32Type	STIME;
	///进程的CPU利用率权重百分比
	TShfeFtdcDoubleTypeType	pWCPU;
	///进程的原始的CPU利用率百分比
	TShfeFtdcDoubleTypeType	pCPU;
	///启动进程的命令名
	TShfeFtdcString64Type	COMMAND;
};

///主机的进程信息
struct CShfeFtdcRtnMonHostProcessInfoField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///数据库采集内容的回传
struct CShfeFtdcRtnMonDBQueryField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
	TShfeFtdcMonTimeType	MonTime;
	///存储过程名，可以为空
	TShfeFtdcString128Type	SPName;
	///数据库查询结果
	TShfeFtdcString1024Type	QueryResult;
};

///客户端临时SP查询请求
struct CShfeFtdcReqQryMonSPQueryField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///数据库别名
	TShfeFtdcString16Type	DBName;
	///存储过程名
	TShfeFtdcString64Type	SPName;
};

///客户端临时SP查询结果状态
struct CShfeFtdcRspMonSPQueryInfoField
{
	///查询结果状态码
	TShfeFtdcINT32Type	ErrorID;
	///查询返回的提示信息
	TShfeFtdcString128Type	ErrorMsg;
};

///服务版本信息请求
struct CShfeFtdcReqServiceVersionField
{
	///服务名称
	TShfeFtdcServiceNameType	ServiceName;
	///服务ID
...
///服务版本信息响应
struct CShfeFtdcRspServiceVersionField
{
	///服务名称
	TShfeFtdcServiceNameType	ServiceName;
	///服务ID
	...
	TShfeFtdcVersionIDType	VersionID;
	///服务MD5码
	TShfeFtdcServiceMD5ValueType	ServiceMD5Value;
	///升级服务MD5码
	TShfeFtdcUpdateMD5ValueType	UpdateMD5Value;
};

///服务应用程序请求
struct CShfeFtdcReqServiceProgramField
{
	///服务名称
	TShfeFtdcServiceNameType	ServiceName;
};
...
///服务应用程序响应
struct CShfeFtdcRspServiceProgramField
{
	///服务名称
	TShfeFtdcServiceNameType	ServiceName;
	///服务应用程序
	TShfeFtdcServiceProgramType	ServiceProgram;
	///应用程序长度
	TShfeFtdcProgramLengthType	ProgramLength;
	///应用程序编号
	TShfeFtdcProgramIdType	ProgramId;
};

///升级服务获取状态
struct CShfeFtdcReqUpdateStateField
{
	///服务名称
	TShfeFtdcServiceNameType	ServiceName;
	///服务ID
	TShfeFtdcServiceIDType	ServiceID;
	///获取应用程序状态
	TShfeFtdcProgramUpdateStateType	ProgramUpdateState;
};

///升级服务获取状态响应
struct CShfeFtdcRspUpdateStateField
{
	///服务名称
	TShfeFtdcServiceNameType	ServiceName;
	///服务ID
...
///订阅请求
struct CShfeFtdcReqSubscribeField
{
	///对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///属性名
...
///文件发送成功通知
struct CShfeFtdcReqFileSendSuccessField
{
	///服务名称
	TShfeFtdcServiceNameType	ServiceName;
	///服务ID
	...
	TShfeFtdcString32Type	Datacenter;
	///文件名称，不包含路径
	TShfeFtdcString256Type	FileName;
	///文件大小
	TShfeFtdcUINT64Type	FileSize;
	///文件在目标主机的存放位置,可以为空
	TShfeFtdcString256Type	TarDir;
	///接收文件的服务名称,可以为空
	TShfeFtdcServiceNameType	TargetServiceName;
	///接收文件的服务ID,可以为空
	TShfeFtdcServiceIDType	TargetServiceID;
	///目标服务所在的数据中心名称,可以为空
	TShfeFtdcString32Type	TargetDatacenter;
};

///回送文件接收成功
struct CShfeFtdcRspFileSendSuccessField
{
	///接收文件的服务名称
	TShfeFtdcServiceNameType	ServiceName;
	///接收文件的服务ID
	...
	TShfeFtdcString256Type	FileName;
	///接收文件的服务名称,可以为空
	TShfeFtdcServiceNameType	SourceServiceName;
	///接收文件的服务ID,可以为空
	TShfeFtdcServiceIDType	SourceServiceID;
	///目标服务所在的数据中心名称,可以为空
	TShfeFtdcString32Type	SourceDatacenter;
};

///文件发送成功通知
struct CShfeFtdcRtnFileSendSuccessField
{
	///服务名称
	TShfeFtdcServiceNameType	ServiceName;
	///服务ID
...
struct CShfeFtdcReqQryMonTomcatInfoField
{
	...
	TShfeFtdcDigitObjectIDType	ObjectID;
	///子监控对象
	TShfeFtdcDigitObjectIDType	SubObjectID;
	///监控指标
	TShfeFtdcDigitAttrTypeType	AttrType;
};

///tomcat信息查询
struct CShfeFtdcRspQryMonTomcatInfoField
{
	///监控时间
	TShfeFtdcMonTimeType	MonTime;
	///监控对象
	...
	TShfeFtdcDigitAttrTypeType	AttrType;
	///通用返回字段
	TShfeFtdcString1024Type	Content;
};

///tomcat信息查询
struct CShfeFtdcRtnMonTomcatInfoField
{
	///监控时间
	TShfeFtdcMonTimeType	MonTime;
	///监控对象
...
///web app信息应答
struct CShfeFtdcRspQryMonWebAppInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
	TShfeFtdcMonTimeType	MonTime;
	///Web应用名称
	TShfeFtdcString32Type	AppName;
	///应用运行状态
	TShfeFtdcString16Type	Status;
	///应用描述信息
	TShfeFtdcString512Type	Desc;
	///应用启动时间
	TShfeFtdcString20Type	StartTime;
	///应用servlet数量
	TShfeFtdcString10Type	ServletNum;
	///应用处理总时长
	TShfeFtdcString20Type	ProcessTime;
	///应用累计接收请求数
	TShfeFtdcString20Type	RequestNum;
	///应用累计错误数
	TShfeFtdcString20Type	ErrorNum;
	///应用当前会话数
	TShfeFtdcString10Type	SessionSize;
	///会话超时时长(秒)
	TShfeFtdcString10Type	TimeOut;
	///应用JDBC连接使用率
	TShfeFtdcString10Type	JDBCUsage;
	///应用JSP文件数量
	TShfeFtdcString10Type	JSPNum;
};

///web app信息推送
struct CShfeFtdcRtnMonWebAppInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
...
///servlet信息推送
struct CShfeFtdcRspQryMonServletInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
	TShfeFtdcMonTimeType	MonTime;
	///servlet名称
	TShfeFtdcString64Type	Name;
	///加载耗时
	TShfeFtdcINT32Type	LoadTime;
	///接收请求数量
	TShfeFtdcINT32Type	RequestNum;
	///错误数量
	TShfeFtdcINT32Type	RequestErrNum;
	///处理时长
	TShfeFtdcINT32Type	ProcessTime;
	///最小处理时间
	TShfeFtdcINT32Type	MixTime;
	///最大处理时间
	TShfeFtdcINT32Type	MaxTime;
};

///servlet信息推送
struct CShfeFtdcRtnMonServletInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
...
///文件信息推送
struct CShfeFtdcRspQryMonFileInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
	TShfeFtdcMonTimeType	MonTime;
	///文件全路径名
	TShfeFtdcString256Type	PathName;
	///文件大小
	TShfeFtdcString10Type	FileSize;
	///文件最后修改时间
	TShfeFtdcString20Type	LastModDate;
	///文件属性
	TShfeFtdcString16Type	FileType;
};

///文件信息推送
struct CShfeFtdcRtnMonFileInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
...
///应用会话信息应答
struct CShfeFtdcRspQryMonSessionInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
	TShfeFtdcMonTimeType	MonTime;
	///Session编号
	TShfeFtdcString32Type	SessionID;
	///Session名称
	TShfeFtdcString64Type	SessionName;
	///Session对应客户端IP地址
	TShfeFtdcString16Type	RemoteIP;
	///Session创建时间
	TShfeFtdcString16Type	BeginTime;
	///Session最新请求时间
	TShfeFtdcString16Type	LatestTime;
	///Session超时时间(秒)
	TShfeFtdcINT32Type	MaxIdleTime;
};

///应用会话信息推送
struct CShfeFtdcRtnMonSessionInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
...
///JDBC信息应答
struct CShfeFtdcRspQryMonJDBCInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
	...
	TShfeFtdcString32Type	AppName;
	///JDBC连接池名称
	TShfeFtdcString32Type	Name;
	///连接池使用比例
	TShfeFtdcRatioType	Usage;
	///最大连接数
	TShfeFtdcINT32Type	ConnNumMax;
	///空闲连接数
	TShfeFtdcINT32Type	ConnNumFree;
	///不可重用连接数
	TShfeFtdcINT32Type	ConnNumUnRU;
	///可重用连接数
	TShfeFtdcINT32Type	ConnNumRU;
	///对应数据库用户
	TShfeFtdcString32Type	UserName;
	///JDBC类型
	TShfeFtdcString64Type	Type;
	///JDBC Url
	TShfeFtdcString64Type	URL;
};

///JDBC信息推送
struct CShfeFtdcRtnMonJDBCInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
...
///线程信息应答
struct CShfeFtdcRspQryMonThreadInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
	...
	TShfeFtdcString64Type	Name;
	///线程编号
	TShfeFtdcINT32Type	ThreadNum;
	///线程状态
	TShfeFtdcString16Type	ThreadStatus;
	///线程Native标识
	TShfeFtdcINT32Type	InNative;
	///线程Suspended标识
	TShfeFtdcString16Type	Suspended;
	///线程阻塞总数
	TShfeFtdcINT32Type	BlockCount;
	///线程等待总数
	TShfeFtdcINT32Type	WaitCount;
	///线程CPU时间
	TShfeFtdcRatioType	CpuTime;
	///线程用户时间
	TShfeFtdcRatioType	UserTime;
...
///线程信息推送
struct CShfeFtdcRtnMonThreadInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
...
///虚拟机信息查询
struct CShfeFtdcReqQryMonVMInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///子监控对象
...
///虚拟机信息应答
struct CShfeFtdcRspQryMonVMInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
	...
	TShfeFtdcString64Type	Name;
	///虚拟机类型
	TShfeFtdcString64Type	VmName;
	///供应商
	TShfeFtdcString64Type	VmVendor;
	///虚拟机版本
	TShfeFtdcString64Type	VmVersion;
	///启动时间
	TShfeFtdcString64Type	StartTime;
	///启动类路径
	TShfeFtdcString800Type	BootClassPath;
	///类路径
	TShfeFtdcString800Type	ClassPath;
	///库路径
	TShfeFtdcString800Type	LibraryPath;
	///启动参数
	TShfeFtdcString800Type	Arguments;
};

///虚拟机信息推送
struct CShfeFtdcRtnMonVMInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
...
///系统属性信息查询
struct CShfeFtdcReqQryMonPropertyInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///子监控对象
...
///系统属性信息
struct CShfeFtdcRspQryMonPropertyInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
	TShfeFtdcMonTimeType	MonTime;
	///系统属性名
	TShfeFtdcString64Type	Property;
	///分割标识
	TShfeFtdcINT32Type	ClipFlag;
	///属性值
	TShfeFtdcString256Type	Value;
};

///系统属性信息
struct CShfeFtdcRtnMonPropertyInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
...
///系统内存池信息查询
struct CShfeFtdcReqQryMonMemPoolInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///子监控对象
...
///系统内存池信息
struct CShfeFtdcRspQryMonMemPoolInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
	TShfeFtdcMonTimeType	MonTime;
	///系统属性名
	TShfeFtdcString32Type	PoolName;
	///系统属性名
	TShfeFtdcString10Type	Usage;
	///系统属性名
	TShfeFtdcString20Type	committedbytes;
	///系统属性名
	TShfeFtdcString20Type	initbytes;
	///系统属性名
	TShfeFtdcString20Type	maxbytes;
	///系统属性名
	TShfeFtdcString20Type	usedbytes;
	///系统属性名
	TShfeFtdcString10Type	Type;
};

///系统内存池信息
struct CShfeFtdcRtnMonMemPoolInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
...
///连接信息查询
struct CShfeFtdcReqQryMonConnectionInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///子监控对象
...
///连接信息应答
struct CShfeFtdcRspQryMonConnectionInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
	TShfeFtdcMonTimeType	MonTime;
	///服务线程名
	TShfeFtdcString32Type	ServiceName;
	///当前状态
	TShfeFtdcString10Type	Stage;
	///累计接收请求数
	TShfeFtdcRatioType	RequestCount;
	///累计错误数
	TShfeFtdcRatioType	ErrorCount;
	...
	TShfeFtdcString16Type	RemoteIP;
	///最大请求URI
	TShfeFtdcString64Type	MaxAccessURI;
};

///连接信息推送
struct CShfeFtdcRtnMonConnectionInfoField
{
	///监控对象
	TShfeFtdcDigitObjectIDType	ObjectID;
	///监控时间
...
///获得监控对象信息查询请求
struct CShfeFtdcReqQryMonitor2ObjectField
{
	///业务进程对象ID，数字形式
	TShfeFtdcDigitObjectIDType	ObjectID;
	///
	TShfeFtdcDigitDateTimeType	StartDateTime;
	///
	TShfeFtdcDigitDateTimeType	EndDateTime;
	///持续订阅标记
	TShfeFtdcTypeKeepAliveType	KeepAlive;
};

///获得监控对象信息应答信息
struct CShfeFtdcRspQryMonitor2ObjectField
{
	///业务进程对象ID，数字形式
	TShfeFtdcDigitObjectIDType	ObjectID;
	///本级业务进程对象名字
...
///获得监控对象信息应答信息
struct CShfeFtdcRtnMonitor2ObjectField
{
	///业务进程对象ID，数字形式
	TShfeFtdcDigitObjectIDType	ObjectID;
	///本级业务进程对象名字
...
///获取主机基础环境信息
struct CShfeFtdcReqQryMonHostCommonEnvField
{
	///主机的数字化对象ID
	TShfeFtdcDigitObjectIDType	HostID;
};
...
///应答主机基础环境信息
struct CShfeFtdcRspQryMonHostCommonEnvField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///推送主机基础环境信息
struct CShfeFtdcRtnMonHostCommonEnvField
{
	///数字化对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///采集时间
...
///获取业务进程和主机关系
struct CShfeFtdcReqQryMonOidHostRationalField
{
	///主机ID，数字形式
	TShfeFtdcDigitObjectIDType	ObjectID;
	///
...
///应答业务进程和主机关系
struct CShfeFtdcRspQryMonOidHostRationalField
{
	///业务进程对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///业务进程所在的主机ID
	TShfeFtdcDigitObjectIDType	HostObjectID;
};

///推送业务进程和主机关系
struct CShfeFtdcRtnMonOidHostRationalField
{
	///业务进程对象ID
	TShfeFtdcDigitObjectIDType	ObjectID;
	///业务进程所在的主机ID
...
///请求业务进程和指标关系
struct CShfeFtdcReqQryMonOidRelationField
{
	///
	TShfeFtdcDigitObjectIDType	ObjectID;
};
...
///应答业务进程和指标关系
struct CShfeFtdcRspQryMonOidRelationField
{
	///定义对象名
	TShfeFtdcDigitObjectIDType	ObjectID;
	///定义对象名
	TShfeFtdcDigitAttrTypeType	HoldAttrID;
};

///推送业务进程和指标关系
struct CShfeFtdcRtnMonOidRelationField
{
	///定义对象名
	TShfeFtdcDigitObjectIDType	ObjectID;
	///定义对象名
